...
const LastHeroSec = () => {
  return (
    <div className="flex items-center justify-center  mx-2 xs:mx-6 my-6 bg-[#d8f1e5] rounded-3xl lg:pl-20 ">
      <div className="">
        <h1 className="pt-16 xs:pl-2 text-[22px] text-wrap   font-bold xs:text-[40px] xs:leading-[46px]  font-quickSand ">
