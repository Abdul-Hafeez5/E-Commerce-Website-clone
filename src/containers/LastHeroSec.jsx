...
const LastHeroSec = ({img}) => {
  return (
    <div className="flex h-full py-6 pl-4 items-center justify-center px-1  mx-2 xs:mx-6 my-6 bg-[#d8f1e5] rounded-3xl lg:pl-20 ">
      <div className="w-full mxs:pl-7">
        ...
        <div className="inline-flex items-center mt-8 ml-1 text-sm bg-white xs:pl-4 xs:text-base rounded-3xl">
