...
const PostNav = () => {
  ...
  return (
    <>
      <hr className="hidden mb-1 md:block bg-primary text-secondary" />
      <div
        className={`hidden lg:flex justify-between font-quickSand text-base font-bold bg-white items-center px-3   z-10 ${
      ...
      <hr className="hidden mt-1 lg:block bg-primary text-secondary" />
    </>
  );
};
